...
--  oracle
           SELECT  DISTINCT
             ...
             FROM  OMS.DT_MEDLIC 
                ,  OMS.DT_MEDCOM 
            WHERE  OMS.DT_MEDCOM .RECORD_IN             (+)  =  OMS.DT_MEDLIC .RECORD_IN_MEDCOM  
              AND  OMS.DT_MEDCOM .DATE_START            (+) <=  SYSDATE
              AND  OMS.DT_MEDCOM .DATE_END              (+) >=  SYSDATE
  AND  OMS.DT_MEDLIC .LIC_DATE_START            <=  to_date('2017-05-05', 'YYYY,MM,DD')
              AND  OMS.DT_MEDLIC .LIC_DATE_END              IS  NULL                                                                      
              AND  OMS.DT_MEDLIC .LIC_DATE_TERM             IS  NULL                                                                      
  /* +Filter (AND  OMS.DT_MEDLIC .RECORD_IN_MEDCOM        JOIN  OMS.DT_MEDCOM .RECORD_IN                                                  
...
UNION                            
           SELECT  DISTINCT      
            ...
            WHERE  OMS.DT_MEDCOM .RECORD_IN             (+)  =  OMS.DT_MEDLIC .RECORD_IN_MEDCOM  
              ...
              AND  OMS.DT_MEDCOM .DATE_END              (+) >=  SYSDATE
  AND  OMS.DT_MEDLIC .LIC_DATE_START            <=  to_date('2017-05-05', 'YYYY,MM,DD')
  AND  OMS.DT_MEDLIC .LIC_DATE_END              >=  to_date('2017-05-05', 'YYYY,MM,DD')
  AND  OMS.DT_MEDLIC .LIC_DATE_TERM             >=  to_date('2017-05-05', 'YYYY,MM,DD')
              AND  OMS.DT_MEDLIC .LIC_DATE_END          IS NOT  NULL                                                                      
              AND  OMS.DT_MEDLIC .LIC_DATE_TERM         IS NOT  NULL                                                                      
  /* +Filter (AND  OMS.DT_MEDLIC .RECORD_IN_MEDCOM        JOIN  OMS.DT_MEDCOM .RECORD_IN                                                  
                                                       BROWSER  F003(фм)/Медицинские организации                                           
                                                         QUERY  F003(фм)/Медицинские организации                                     ) */
  /* +Filter (AND  OMS.DT_MEDCOM .RECORD_IN_TSFOMS        JOIN  OMS.DT_TSFOMS .RECORD_IN                                                  
...
-- postgresql
           SELECT  DISTINCT
             ...
             FROM  OMS.DT_MEDLIC 
                left join  OMS.DT_MEDCOM on  OMS.DT_MEDCOM .temp_id            =  OMS.DT_MEDLIC .dt_medcom_id
              AND  OMS.DT_MEDCOM .bdate             <=  now()
              AND  OMS.DT_MEDCOM .edate               >=  now()
  where  OMS.DT_MEDLIC .LIC_date_start            <=  to_date('2017-05-05', 'YYYY,MM,DD')
              and  OMS.DT_MEDLIC .LIC_DATE_END              IS  NULL                                                                      
              AND  OMS.DT_MEDLIC .LIC_DATE_TERM             IS  NULL                                                                      
  /* +Filter (AND  OMS.DT_MEDLIC .RECORD_IN_MEDCOM        JOIN  OMS.DT_MEDCOM .RECORD_IN                                                  
                                                       BROWSER  F003(фм)/Медицинские организации                                           
